...
const PLANS = {
    free: {
        ...
        quota:    5,
        trial_days: 3,
        features: ['3 أيام مجانية', '5 استشارات تجريبية', 'جميع أنواع التحليل', 'لا بطاقة ائتمان مطلوبة'],
    },
    basic: {
        label:    'الأساسي',
        amount:   19900,  // 199 ريال
        quota:    100,
        features: ['100 استشارة شهرياً', 'جميع أنواع التحليل', 'رفع PDF و DOCX', 'تصدير PDF للتقارير', 'دعم بريد إلكتروني'],
    },
    pro: {
        label:    'المتقدم',
        amount:   39900,  // 399 ريال
        quota:    500,
        features: ['500 استشارة شهرياً', 'جميع مميزات الأساسي', 'API للدمج المباشر', 'دعم مباشر 24/7', 'لوحة تحكم المؤسسة', 'امتثال CBAHI'],
    },
};
