...
const PLANS = {
    ...
    basic: {
        ...
        quota:    100,
        features: ['100 استشارة شهرياً', 'جميع أنواع التحليل', 'رفع PDF و DOCX', 'دعم بريد إلكتروني', 'تصدير النتائج'],
    },
    pro: {
        label:    'المتقدم',
        amount:   39900,  // 399 ريال
        quota:    500,
        features: ['500 استشارة شهرياً', 'جميع مميزات الأساسي', 'API للدمج المباشر', 'دعم مباشر على مدار الساعة', 'لوحة تحكم المؤسسة', 'امتثال CBAHI'],
    },
};
